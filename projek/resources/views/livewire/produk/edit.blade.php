    ...
    <div wire:ignore.self class="modal fade" id="editproduk" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-normal" id="exampleModalLabel"><b>Tambah Produk</b> </h5>
                    <button wire:click='resettext' type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <form>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="is-filled input-group input-group-outline my-3">
                ...
                <div class="modal-footer">
                    <button wire:click='resettext' type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Close</button>
